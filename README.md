...
- The response example is wrapped in a JSON object which has the media type, i.e. "application/json" as the key, and the example as the body. 
[Issue 8](https://github.com/mattfrear/Swashbuckle.Examples/issues/8) I'm not sure what causes this, but I suspect it's a bug in swagger-ui.
